  ...
  return (
    <header className="container mx-auto px-4 py-12 lg:py-16">
      <div className="relative grid grid-cols-1 gap-8 md:grid-cols-[auto_1fr]">
        <div className="-rotate-90 writing-mode-vertical hidden text-xl font-medium tracking-wider text-zinc-900 md:block pt-[29rem]">
          EXPLORE NEW AND POPULAR STYLES
        </div>
        <div className="-rotate-90 text-xl font-medium tracking-wider text-zinc-900 md:hidden">
          EXPLORE NEW AND POPULAR STYLES
        </div>
